...
//     public GameObject deathScreen; // We will drag the UI Panel here later
//     public float respawnDelay = 3.5f; // Total time to wait before respawning

//     void Start()
//     {
//         // Auto-find the player script if you forgot to drag it in
//         if (playerController == null)
//         {
//             playerController = FindObjectOfType<PlayerControl>();
//         }
...
//         // 3. Wait 1 second so the "falling down" animation is clearly visible
//         yield return new WaitForSeconds(1.0f);

//         // 4. Show the "YOU DIED" Screen
//         if (deathScreen != null)
//         {
//             deathScreen.SetActive(true);
//         }

//         // 5. Wait the remaining time (reading time)
